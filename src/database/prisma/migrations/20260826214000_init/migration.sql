...
CREATE TABLE "authorized_guilds" (
    ...
    CONSTRAINT "authorized_guilds_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "authorized_guilds_guild_id_key" ON "authorized_guilds"("guild_id");

-- CreateIndex
CREATE UNIQUE INDEX "task_batches_announcement_id_key" ON "task_batches"("announcement_id");

-- CreateIndex
CREATE INDEX "task_batches_guild_id_idx" ON "task_batches"("guild_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "bot_config_guild_id_key" ON "bot_config"("guild_id");
